...
try {
    ...
    $mail->Username   = 'contato@grazyferreiraemagrecimento.com.br';                     // SMTP username
    $mail->Password   = 'GrazyRo250513';                               // SMTP password
    //$mail->SMTPSecure = 'ssl';                                  // Enable TLS encryption, `ssl` also accepted
    $mail->Port       = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('contato@grazyferreiraemagrecimento.com.br', 'SITE');
    $mail->addAddress('contato@grazyferreiraemagrecimento.com.br', 'contato@grazyferreiraemagrecimento.com.br');     // Add a recipient
